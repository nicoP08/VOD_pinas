...
<body>
  ...
  <main>
		<div class="container">
		<p class="affiche">
    <img src="../img/affiche1.jpg" name="affiche" alt="affiche" width="350px" height="350px"/>
	</p>
...
$reponse3 = $dbh->query("SELECT annee FROM annee NATURAL JOIN sort NATURAL JOIN films WHERE titre='Captain America'");
$reponse4 = $dbh->query("SELECT resume FROM synopsis NATURAL JOIN resume NATURAL JOIN films WHERE titre='Captain America'");

$dbh = new PDO("mysql:host=$host_name; dbname=$database;", $user_name, $password,array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES utf8') );

	?>
  	<video controls src="../ba/ca1.mp4">Ici la description alternative</video>
